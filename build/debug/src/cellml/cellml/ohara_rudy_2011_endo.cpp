...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> Cellohara_rudy_2011_endoFromCellML::UseCellMLDefaultStimulus()
    {
    ...
    double Cellohara_rudy_2011_endoFromCellML::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[9];
    }
    
    Cellohara_rudy_2011_endoFromCellML::Cellohara_rudy_2011_endoFromCellML(boost::shared_ptr<AbstractIvpOdeSolver> pSolver, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
        : AbstractCardiacCell(
                pSolver,
                41,
                0,
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<Cellohara_rudy_2011_endoFromCellML>::Instance();
        Init();
    ...
    Cellohara_rudy_2011_endoFromCellML::~Cellohara_rudy_2011_endoFromCellML()
    {
    }
    
    double Cellohara_rudy_2011_endoFromCellML::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_ICaL__PhiCaL = (4.0 * var_membrane__vffrt * ((var_chaste_interface__intracellular_ions__cass * exp(2.0 * var_membrane__vfrt)) - (0.34100000000000003 * mParameters[2]))) / (exp(2.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_ICaL__PhiCaNa = (1.0 * var_membrane__vffrt * ((0.75 * var_chaste_interface__intracellular_ions__nass * exp(1.0 * var_membrane__vfrt)) - (0.75 * mParameters[4]))) / (exp(1.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_ICaL__PhiCaK = (1.0 * var_membrane__vffrt * ((0.75 * var_chaste_interface__intracellular_ions__kss * exp(1.0 * var_membrane__vfrt)) - (0.75 * mParameters[3]))) / (exp(1.0 * var_membrane__vfrt) - 1.0); // dimensionless
        ...
        const double var_INaCa_i__h7_i = 1.0 + ((mParameters[4] * 0.011348161597821153) * (1.0 + (1.0 / var_INaCa_i__hna))); // dimensionless
        const double var_INaCa_i__h8_i = mParameters[4] / (88.120000000000005 * var_INaCa_i__hna * var_INaCa_i__h7_i); // dimensionless
        ...
        const double var_INaCa_i__h7_ss = 1.0 + ((mParameters[4] * 0.011348161597821153) * (1.0 + (1.0 / var_INaCa_i__hna))); // dimensionless
        const double var_INaCa_i__h8_ss = mParameters[4] / (88.120000000000005 * var_INaCa_i__hna * var_INaCa_i__h7_ss); // dimensionless
        ...
        const double var_INaK__a3 = (1899.0 * pow(mParameters[3] * 2.7917364600781687, 2.0)) / ((pow(1.0 + (mParameters[4] / var_INaK__Knao), 3.0) + pow(1.0 + (mParameters[3] * 2.7917364600781687), 2.0)) - 1.0); // dimensionless
        const double var_INaK__b2 = (39.399999999999999 * pow(mParameters[4] / var_INaK__Knao, 3.0)) / ((pow(1.0 + (mParameters[4] / var_INaK__Knao), 3.0) + pow(1.0 + (mParameters[3] * 2.7917364600781687), 2.0)) - 1.0); // dimensionless
        ...
        const double var_INab__INab = (mParameters[8] * var_membrane__vffrt * ((var_chaste_interface__intracellular_ions__nai * exp(var_membrane__vfrt)) - mParameters[4])) / (exp(var_membrane__vfrt) - 1.0); // microA_per_microF
        const double var_IKb__IKb = mParameters[7] * (1.0 / (1.0 + exp((-(var_chaste_interface__membrane__v - 14.48)) * 0.054525627044711013))) * (var_chaste_interface__membrane__v - var_reversal_potentials__EK); // microA_per_microF
        ...
        const double var_ICab__ICab = (mParameters[6] * 4.0 * var_membrane__vffrt * ((var_chaste_interface__intracellular_ions__cai * exp(2.0 * var_membrane__vfrt)) - (0.34100000000000003 * mParameters[2]))) / (exp(2.0 * var_membrane__vfrt) - 1.0); // microA_per_microF
    ...
    void Cellohara_rudy_2011_endoFromCellML::EvaluateYDerivatives(double var_chaste_interface__environment__time, const std::vector<double>& rY, std::vector<double>& rDY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
    ...
    std::vector<double> Cellohara_rudy_2011_endoFromCellML::ComputeDerivedQuantities(double var_chaste_interface__environment__time, const std::vector<double> & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__membrane__v = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
...
template<>
void OdeSystemInformation<Cellohara_rudy_2011_endoFromCellML>::Initialise(void)
{
